...
public class OptionsScreen extends AbstractScreen {
    public OptionsScreen(com.jtveiro.pong.RealPongGame game) {
        super(game);
    }
    ...
    public void render(float delta) {
        ...
        bitmapFont.draw(spriteBatch,"Options", com.jtveiro.pong.Constants.SCREEN_WIDTH/2, com.jtveiro.pong.Constants.SCREEN_HEIGHT - com.jtveiro.pong.Constants.SCREEN_HEIGHT/8,0, Align.center,false);
